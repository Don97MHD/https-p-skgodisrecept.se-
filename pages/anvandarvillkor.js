...
const TermsOfServicePage = ({ content, allRecipes, categories, siteConfig }) => {
    return (
        <Layout 
            title={content.title} 
...
export async function getStaticProps() {
    ...
    // التغيير الوحيد هنا هو مفتاح البحث 'terms'
    const pageContent = pagesData.find(p => p.key === 'terms');
